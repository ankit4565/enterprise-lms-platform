package com.enterprise.courseservice.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public catalogue, category browsing, and course reviews
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/courses/*/reviews").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/courses/{slugOrId}").permitAll()
